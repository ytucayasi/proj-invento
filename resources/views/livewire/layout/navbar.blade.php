...
<nav class="max-w-7xl mx-auto flex justify-between items-center p-4 2xl:px-0 h-fit">
    ...
    <div class="flex items-center space-x-2">
        ...
        <x-dropdown position="bottom-end" class="fit">
            ...
            <x-dropdown.item icon="chat-bubble-left" label="Mensajes" class="dark:hover:text-white" />
            <x-dropdown.item icon="phone" label="Contacto" class="dark:hover:text-white" />
            <x-dropdown.item separator icon="user-group" label="Mesa de Ayuda" class="dark:hover:text-white" />
            <x-dropdown.item icon="wrench-screwdriver" label="Herramientas" class="dark:hover:text-white" />
